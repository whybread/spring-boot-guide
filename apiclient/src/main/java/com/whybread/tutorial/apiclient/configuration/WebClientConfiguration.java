package com.whybread.tutorial.apiclient.configuration;
...
/*
 * We can implement a Non-blocking I/O using WebClient (while blocking is also possible).
 * 
...
// Without setters, the annotation will not be applied.
@ConfigurationProperties(prefix = "api.web-client")
// Needed for external configuration (setters would be used by the @ConfigurationProperties annotation).
@Setter
public class WebClientConfiguration {
   ...
   * To learn more, follow the links above (at the class declaration).
   * 
  ...
  public WebClient myWebClient2() {
    ...
    WebClient myWebClient = WebClient.builder().baseUrl(baseUrl).defaultCookie("cookieKey", "cookieValue")
